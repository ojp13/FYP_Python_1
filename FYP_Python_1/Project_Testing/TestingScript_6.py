...
for train_size in range(2, test_steps):
...
plt.ylim([55,100])
plt.title("Accuracy of knn classifier with different training set sizes \nfor a fixed test set size with k = " + str(n_neighbors))
